defmodule Module1Web.WorkingtimeControllerTest do
  use Module1Web.ConnCase
  ...
  @update_attrs %{
    end: ~N[2022-10-25 15:25:00],
    start: ~N[2022-10-25 15:25:00]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2022-10-24T15:25:00",
               "start" => "2022-10-24T15:25:00"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2022-10-25T15:25:00",
               "start" => "2022-10-25T15:25:00"
             } = json_response(conn, 200)["data"]
    end
